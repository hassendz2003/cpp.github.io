(function(t) {
    ...
    "337e": function(t, e, a) {
        t.exports = a.p + "img/Staking FAQCSEStakingPlatform_logo_transparent.6346e957.png"
    },
    4678: function(t, e, a) {
        var n = {
            "./af": "2bfb",
    ...
    "56d7": function(t, e, a) {
        ...
        var n = a("2b0e"),
            r = function() {
                ...
                return n("v-app", [n("header", {
                    ...
                    attrs: {
                        href: "https://shasta.tronscan.org/#/contract/TZ5p2Z41VHSVBSxZWvXhdzMgxExXc1G8Yx"
                    }
                    ...
                    attrs: {
                        href: "https://twitter.com/StakingDefi",
                        target: "_blank"
                    }
                }, [n("i", {
            ...
            l = a("7f45"),
            c = a.n(l),
            u = "TZ5p2Z41VHSVBSxZWvXhdzMgxExXc1G8Yx",
        ...
        var W = new E["a"]({
            ...
            N = function() {
                ...
                }, [t._v("Daily Auction Lobby, Daily Tron Dividends, Lucrative Staking System, Completely Decentralized.")]), a("div", {
            ...
            Y = [function() {
                ...
                }, [t._v("CSE Staking Platform built on "), a("span", [t._v("Tron")])])
            }, function() {
                var t = this,
                    e = t.$createElement,
                    a = t._self._c || e;
                return a("p", [a("b", [t._v("Stake it till you make it - ")]), t._v("Longer and Bigger Pays Better!")])
            }],
            z = {},
            ...
            U = [function() {
                ...
                }), a("h4", [t._v("Daily Auction Lobby")]), a("p", [t._v("Our Daily Auctions will start from 2.5 million CSE tokens per day and will be distributed between the users that participated in Auction based on their purchase amount. This will reduce over the next 365 days.")])])]), a("div", {
                    staticClass: "col-md-4 col-sm-6",
                    attrs: {
                        "data-aos": "fade-left"
                    }
                ...
                }), a("h4", [t._v("Lucrative Staking System")]), a("p", [t._v("Stake your CSE tokens within the Staking Portal and earn daily interest. Additionally, Stakers are rewarded TRX tokens from the daily Lobbies based off the percentage of total tokens being Staked.")])])])])])])
            }],
            $ = {},
            ...
            Q = [function() {
                ...
                }), n("h1", [t._v("Join our "), n("span", [t._v("Community")])]), n("p", [t._v("Learn more about the project, interact with the team, and take a part in shaping the future of CSE Staking Platform.")]), n("div", {
                    staticClass: "row"
                }, [n("div", {
                    staticClass: "col-md-6",
                    attrs: {
            ...
            it = function() {
                ...
                }, [t._v(" CSE Balance: " + t._s(t.user.formattedBalance))])], 1)], 1), a("v-card", {
                    staticClass: "mx-auto",
                    attrs: {
                        col: 6
                    }
                ...
                }, [t._v(" " + t._s(t.abbreviate_number(t.stakeShareRate, 2) + "/CSE") + " ")]), a("v-list-item-subtitle")], 1), a("v-icon", {
                    staticStyle: {
                        background: "linear-gradient(272.25deg, rgba(7, 214, 98, 0.15) 0.08%, rgba(13, 202, 49, 0.15) 95.38%, rgba(91, 191, 0, 0.15) 95.38%)",
                    ...
                    doStake: function() {
                        ...
                        this.loading = !0, this.mainContract.balanceOf(this.user.address).call({
                            ...
                            window.tronWeb.fromSun(e._hex) / 100 < parseFloat(t.amountToStake) ? (t.snackbar = !0, t.text = "Something went wrong. Remove decimal value, if present, otherwise Insufficient Balance!", t.color = "error") : t.mainContract.stakeStart(parseFloat(t.amountToStake) * Tt, parseInt(t.daysToStake)).send({
                                ...
                                }), 5e3), t.snackbar = !0, t.color = "#07d662", t.text = "Successfully staked ".concat(parseFloat(t.amountToStake), " CSE for ").concat(parseInt(t.daysToStake), " days.")
                            })).catch((function(e) {
        ...
        var ie = function() {
                ...
                }, [a("v-toolbar-title", [t._v("Auction FAQ")]), a("v-spacer"), a("p", {
                    staticStyle: {
                        color: "white !important"
                    }
                ...
                }, [a("v-expansion-panel", [a("v-expansion-panel-header", [t._v("What are auction lobbies?")]), a("v-expansion-panel-content", [t._v(" Auction lobbies are Daily Auctions that offer CSE tokens for TRON based on the CSE and TRON pool at the end of the day. ")])], 1), a("v-expansion-panel", [a("v-expansion-panel-header", [t._v("How much CSE do lobbies pay?")]), a("v-expansion-panel-content", [t._v("Lobbies CSE pool will start from 2.5 million CSE per day and goes until 1 million over the next 365 days but never goes lower than 1 million tokens per day.")])], 1), a("v-expansion-panel", [a("v-expansion-panel-header", [t._v("Buying tokens from exchange or participating in auction?")]), a("v-expansion-panel-content", [t._v("It is more profitable to purchase CSE tokens in the Auction lobby rather than on exchanges. Stake holders are rewarded via dividends from the daily TRX pool.")])], 1), a("v-expansion-panel", [a("v-expansion-panel-header", [t._v("Where does all the TRON go?")]), a("v-expansion-panel-content", [t._v("Dividends, well at least 97% of them! The other 3% is reserved for promotion and platform development costs.")])], 1), a("v-expansion-panel", [a("v-expansion-panel-header", [t._v("When do lobbies end?")]), a("v-expansion-panel-content", [t._v("Lobbies are daily and restart every day at 00:00 UTC")])], 1)], 1)], 1)], 1), a("v-col", {
                    staticClass: "pa-2",
                    attrs: {
                        lg: "8",
                        md: "8",
                    ...
                    enterLobbyFinal: function() {
                        ...
                        return ve(i.a.mark((function e() {
                            ...
                            return i.a.wrap((function(e) {
                                while (1) switch (e.prev = e.next) {
                                    case 0:
                                        return t.dialog = !1, t.snackbar = !0, t.color = "#07d662", t.text = "Confirming " + t.amountToStake + " into auction, standby...", a = localStorage.getItem("referrerAddress") || "TUkY7QsBEX4EBSvhuTFeswFTap8UV3baYc", e.prev = 5, e.next = 8, t.mainContract.xfLobbyEnter(a).send({
                                            shouldPollResponse: !1,
        ...
        var _e = function() {
                ...
                }, [a("v-card-title", [t._v("TRON Dividends")]), a("v-card-text", [t._v("One of the benefits of Staking CSE is TRON dividends. At the end of each day a TRON dividends pool will be calculated and allocated to all the open stakes based on their stake amount. The TRON dividends pool comes from the total daily entry of auction lobby.The only way to receive TRON Dividends is having open stakes")]), a("v-row", {
                    staticClass: "ml-4 mr-4"
                }, [a("v-card-subtitle", [t._v("Current Dividends Pool")]), a("v-text-field", {
                    staticClass: "px-4",
                    attrs: {
                        outlined: "",
                        label: "",
                ...
                }, [a("v-card-title", [t._v("Dividend History")]), a("line-chart", {
                    attrs: {
                        data: t.valuesObj
                    }
                })], 1)], 1)
        ...
        var Ie = function() {
                ...
                }, [a("v-card-title", [t._v("Your Referral Link")]), a("v-card-text", [t._v("Your referrals will earn an extra 5% minted CSE tokens on their Auction Lobby Purchase. As a referrer you will earn an extra 10%. There are no limits on number nor the amount of referrals that you can get.")]), a("v-row", {
                    staticClass: "ml-4 mr-4"
                }, [a("v-text-field", {
                    staticClass: "px-4",
                    attrs: {
        ...
        var Ve = {
                data: function() {
                    return {
                        address: "",
                        referral: "https://csetron.github.io?ref=".concat(this.address)
                    }
                },
                mounted: function() {
                    var t = this,
                                ...
                                return i.a.wrap((function(e) {
                                    while (1) switch (e.prev = e.next) {
                                        case 0:
                                            ...
                                            return e.abrupt("return", a(!1));
                                        case 3:
                                            t.address = n, t.referral = "https://csetron.github.io?ref=".concat(t.address);
                                            try {
                                                setInterval((function() {
